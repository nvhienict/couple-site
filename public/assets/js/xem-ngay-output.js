...
var ABOUT = "Dev by prdonggiang@gmail.com"+"\nhttp://thuna.vn";
var TK19 = new Array(
...
function getNgayKhacChuRe(){
	var ngay_khac_chu_re 	= $('#gh').text().split(',');

	return ngay_khac_chu_re;
}
function getNgayKhacCoDau(){
	var ngay_khac_co_dau = $('#hg').text().split(',');

	return ngay_khac_co_dau;
}

function checkInNgayKhacChuRe(value){
	return getNgayKhacChuRe().indexOf(""+value+"");
}
function checkInNgayKhacCodau(value){
	return getNgayKhacCoDau().indexOf(""+value+"");
}
...
function printStyle() {
	...
	res += '  .ngayxaunhat {background-color:#544f4f}\n';
	res += '-->\n';
	res += '</style>\n';
	return res;
}
...
function getPrevMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'"><img src="../icon/month-r.png" width=27 height=25 alt="PrevMonth" title="Tháng trước" border=0></a>';
...
function getNextMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'"><img src="../icon/month-l.png" width=27 height=25 alt="NextMonth" title="Tháng sau" border=0></a>';
	// return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'">&gt;</a>';
}

function getPrevYearLink(mm, yy) {
	return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><img src="../icon/year-r.png" width=27 height=25 alt="PrevYear" title="Năm trước" border=0></a>';
	// return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'">&lt;&lt;</a>';
}

function getNextYearLink(mm, yy) {
	return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><img src="../icon/year-l.png" width=27 height=25 alt="PrevYear" title="Năm sau" border=0></a>';
	// return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'">&gt;&gt;</a>';
}
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	var cc = getCanChi(lunarDate);
	var dayChi = getDayChi(lunarDate);
...
function showVietCal() {
	window.status = getCurrentTime() + " Nhằm " + getTodayString();

<article id="content">
	...
	<div class="wrapper">
		<div class="row phara-margin">
            ...
            <div class="col-xs-12 col-md-5 col-sm-5 col-lg-5 col-md-offset-1 col-sm-offset-1 col-offset-lg-1 show-content phara{{$tabWeb->id}}"  onclick="showckeditor_text({{$tabWeb->id}})">

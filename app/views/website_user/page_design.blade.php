			...
			<div class="tab-content" style="padding: 5px;">
			  	...
			  	<div class="tab-pane" id="design_page">
			  		<table class="website_tabs">
						<tr class="odd">
							<td><input type="text" name="" value="1" size="2" class="website_tabs_input"></td>
							<td>Welcome</td>
							<td><span id="giang" class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="even">
							<td><input type="text" name="" value="2" size="2" class="website_tabs_input"></td>
							<td>About</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="odd">
							<td><input type="text" name="" value="3" size="2" class="website_tabs_input"></td>
							<td>Sự kiện cưới</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="even">
							<td><input type="text" name="" value="4" size="2" class="website_tabs_input"></td>
							<td>Du lịch</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="odd">
							<td><input type="text" name="" value="5" size="2" class="website_tabs_input"></td>
							<td>Đăng ký</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="even">
							<td><input type="text" name="" value="6" size="2" class="website_tabs_input"></td>
							<td>Album ảnh</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="odd">
							<td><input type="text" name="" value="7" size="2" class="website_tabs_input"></td>
							<td>Liên lạc</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
						<tr class="even">
							<td><input type="text" name="" value="8" size="2" class="website_tabs_input"></td>
							<td>Lời chúc</td>
							<td><span class="glyphicon glyphicon-cog"></span></td>
						</tr>
					</table>

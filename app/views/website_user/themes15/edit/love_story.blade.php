...
<div class="partion">
	<div class="row phara-margin">
       	<div class="item-content" style="text-align: {{$tabWeb->titlestyle}}; font-familly: {{$website_item->font}}; color: #{{$website_item->color2}} " id = "nameTitle{{$tabWeb->id}}">
            {{$tabWeb->title}}
        </div>
        ...
        <div class="item-content editphara{{$tabWeb->id}}">

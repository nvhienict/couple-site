            ...
            <?php $check=PhotoTab::where('user',$website_item->user)->get()->count();?>
                ...
                @else
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 images-padding">
                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{Asset("images/website/themes20/1.jpg")}}">
                                <img class="img-responsive" src="{{Asset("images/website/themes20/1.jpg")}}" alt="" />
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 images-padding">
                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{Asset("images/website/themes20/2.jpg")}}">
                                <img class="img-responsive" src="{{Asset("images/website/themes20/2.jpg")}}" alt="" />
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 images-padding">
                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{Asset("images/website/themes20/3.jpg")}}">
                                <img class="img-responsive" src="{{Asset("images/website/themes20/3.jpg")}}" alt="" />
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 images-padding">
                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{Asset("images/website/themes20/4.jpg")}}">
                                <img class="img-responsive" src="{{Asset("images/website/themes20/4.jpg")}}" alt="" />
                            </a>
                        </div>

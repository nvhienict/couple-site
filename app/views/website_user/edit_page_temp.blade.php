            ...
            <div class="row section" id="section-welcome">
                <div class="col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <h3>Project One</h3>
                            <h4 style="color: #{{$website_item->color3}}">Subheading</h4>
                            <p style="color: #{{$website_item->color3}}">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium veniam exercitationem expedita laborum at voluptate. Labore, voluptates totam at aut nemo deserunt rem magni pariatur quos perspiciatis atque eveniet unde.</p>                   
                        </div>
                    </div>
                    <div class="row">
